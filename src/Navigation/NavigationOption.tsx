export default function NavigationOption({setPageIndex,PageVar,className,PageIndex}:{setPageIndex:Function,PageVar:any,className:string,PageIndex:Number}):JSX.Element{
   let NavOptionStyle = []
    return(
